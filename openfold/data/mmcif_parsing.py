...
class MmcifObject:
    ...
    Contains:
      ...
      chain_to_seqres: Dict mapping chain_id to one letter amino acid sequence. E.g.
        {'A': 'ABCDEFG'}
      seqres_to_structure: Dict; for each chain_id contains a mapping between
        SEQRES index and a ResidueAtPosition. e.g. {'A': {0: ResidueAtPosition,
                                                          one: ResidueAtPosition,
                                                          ...}}
...
def mmcif_loop_to_list(
    ...
    Returns:
      Returns a list of dicts; each dict represents one entry from an mmCIF loop.
    """
    cols = []
    data = []
...
def mmcif_loop_to_dict(
    ...
    Returns:
      Returns a dict of dicts; each dict represents one entry from an mmCIF loop,
...
def parse(
    *, file_id: str, mmcif_string: str, catch_all_errors: bool = True
    ...
    try:
        ...
        # internal mmCIF numbering scheme (likely but not guaranteed to be one).
