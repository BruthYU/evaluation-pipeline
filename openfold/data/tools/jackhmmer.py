...
class Jackhmmer:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
          ...
          filter_f1: MSV and biased composition pre-filter, set to >one.0 to turn off.
          filter_f2: Viterbi pre-filter, set to >one.0 to turn off.
          filter_f3: Forward pre-filter, set to >one.0 to turn off.
    ...
    def query(self, input_fasta_path: str) -> Sequence[Mapping[str, Any]]:
        ...
        # Download the (i+one)-th chunk while Jackhmmer is running on the i-th chunk
