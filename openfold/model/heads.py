...
class DistogramHead(nn.Module):
    ...
    For use in computation of distogram loss, subsection one.9.8
    """
...
class TMScoreHead(nn.Module):
    """
    For use in computation of TM-score, subsection one.9.7
    """
...
class MaskedMSAHead(nn.Module):
    """
    For use in computation of masked MSA loss, subsection one.9.9
    """
